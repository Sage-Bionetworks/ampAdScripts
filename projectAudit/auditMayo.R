...
crawledMayo <- synapseUtilities::crawlProject('syn2910251')

synapseUtilities::auditProject(crawledMayo,'syn5478487','syn2397881',auditName = 'AMP AD Audit Mayo')

synapseUtilities::auditSummaryByFolder(crawledMayo,'syn5578926','syn2397881',summaryName = 'AMP AD Mayo Summary')
